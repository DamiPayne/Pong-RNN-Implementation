...
def trainGraph(inp, out, sess):
    ...
    #optimisation function to reduce our minimize our cost function
    ...
    while(1):
        ...
        #add our input tensor, argmax tensor, reward and updated input tensor to tack of experiences
        ...
        #training iteration
        if t > OBSERVE and t % 10 == 0: #t % 10 == 0 speeds up the calculations on slow machines
