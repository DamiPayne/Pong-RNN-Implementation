#!/usr/bin
#2d pong game built using pygame
#To illustrate QLearning techniques
...
#update the ball, using the paddle positions the balls positions and the balls directions
...
class PongGame:
    def __init__(self):
        ...
        #keep score
        self.tally = 0
        #initialise positions of paddle
